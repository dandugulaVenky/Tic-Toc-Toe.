...
export const Food = () => {
    ...
    //filter type burger/pizz/salad/etc..
  ...
  return (
   <div className='max-w-[1640px] m-auto px-4 py-12 '>
    <h1 className='text-orange-600 font-bols text-4xl text-center'>Top Rated Menu Items</h1>

    {/* {Filter Row} */}
    <div className='flex flx-col lg:flex-row justify-between '>
        {/* {filter type} */}
        <div>
        ...
        <div>
            ...
            <div className='flex justify-between max-w-[390px] w-full'>
                ...
                <button onClick={() => filterPrice('$25')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$25</button>
      ...
      {foods.map((item, index) => (
        <div key={index} className='border shadow-lg rounded-lg hover:scale-105 duration-300 '>
            ...
            <div className='flex justify-between px-2 py-4'>
                ...
                <p>
                    <span className='bg-orange-500 rounded-full text-white p-1'>{item.price}</span>
                </p>
            </div>
        </div>
      ))}
